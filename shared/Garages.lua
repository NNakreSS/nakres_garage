Config.Garages = {
    ["motelgarage"] = {
        ...
        ["previewPoint"] = vector4(274.69, -330.25, 44.92, 166.89),
        ["showBlip"] = true,
        ["blipName"] = "Garage",
        ["blipNumber"] = 357,
        ["blipColor"] = 3,
        ["type"] = "public", --- public, job, gang, depot , house
        ...
        ['limit'] = 10,
        ['previewsCoords'] = {vector4(265.71, -331.87, 44.51, 250.0), vector4(267.71, -329.06, 44.51, 250.21),
                              vector4(268.84, -325.82, 44.51, 248.74)}
    },
    ["casinogarage"] = {
